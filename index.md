...
Listed Below are all functions created in the project followed by test code - the soltution that I coded and successfully executed in Terminal for the Graphing Calculator Project.
